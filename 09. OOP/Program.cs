namespace _09._OOP
{
    internal class Program
    {
       ...
       ****************************************************************/
        ...
        // <객체지향의 등장배경>
        // 물리적인 하드웨어의 발전(용량이 늘어남)이 빠르게 진행되었으며, 소프트웨어의 중요성이 빠르게 흘러감
        ...
        // 추상화 : 관련특성 및 엔터티의 상호작용을 클래스로 모델링하여 시스템의 추상적 표현을 정의
        // 캡슐화 : 객체를 상태와 기능으로 묶는 것을 의미하며, 객체의 내부 상태와 기능을 숨기고, 허용한 상태와 기능만의 엑세스 허용 
